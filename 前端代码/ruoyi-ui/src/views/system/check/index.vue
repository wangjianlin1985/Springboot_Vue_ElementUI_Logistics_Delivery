<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      <el-form-item label="仓库编号" prop="ckNum">
        <el-input
    ...
    <el-table v-loading="loading" :data="checkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="仓库编号" align="center" prop="ckNum" />
      <el-table-column label="温度" align="center" prop="ckTemp" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="仓库编号" prop="ckNum">
          <el-input v-model="form.ckNum" placeholder="请输入仓库编号" />
        </el-form-item>
        <el-form-item label="温度" prop="ckTemp">
          <el-input v-model="form.ckTemp" placeholder="请输入温度" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除仓库检查编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有仓库检查数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
